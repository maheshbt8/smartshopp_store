...
class Response {
  ...
  int notify;
  String appType;
  Response({this.error, this.data, this.accessToken, this.notify, this.appType});
  factory Response.fromJson(Map<String, dynamic> json){
    ...
    return Response(
      ...
      appType: (json['appType'] == null) ? "basic" : json['appType'].toString(),
      data: a,
    );
  }
}
