...
selectImage(double windowWidth, Function callback, Color _color, Color _colorText){
  return Stack(
    children: [
      Container(
        ...
        child: Container(
          ...
          child: Opacity(
              opacity: 0.6,
              child: Text(strings.get(125), style: TextStyle(
                color: _colorText,
        ...
        child: UnconstrainedBox(
            child: Container(
                ...
                child: Image.asset("assets/selectimage.png",
                    fit: BoxFit.contain, color: _colorText,
                )
            )),
      ),
...
Widget drawImageLocal(String image, double windowWidth, bool delete, Function(String) callback, String id){
  if (image.isNotEmpty)
    return Row(
      children: [
        Expanded(
        ...
        Expanded(
          flex: 1,
          child: IButton3(color: theme.colorPrimary,
...
Widget drawImageServer(String serverImage, double windowWidth, bool delete, Function(String) callback, String id){
...
Widget drawImageServer2(String serverImage){
  if (serverImage.isNotEmpty)
    return Container(
          width: 100,
          height: 100,
